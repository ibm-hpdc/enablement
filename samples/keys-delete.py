...
parser.add_argument('--keyset', '-ks', help='Key set name')
parser.add_argument('--key', '-k', help='Key name')
...
url = f'https://{hpdchost}:19443/keys/{keyset}/{key}'
